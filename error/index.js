...
const { NAME_AND_PASSWORD_IS_REQUIRED, USER_NAME_IS_EXISTS, USER_NAME_IS_NOT_EXISTS, PASSWORD_IS_NOT_CORRECT, TOKEN_IS_INVALID, AMOUNT_IS_INVALID, CDKEY_IS_INVALID, ORDER_NO_IS_REQUIRED, ORDER_NO_IS_INVALID, AVATAR_IS_REQUIRED } = require("./errorTypes");
...
const errorHandler = async (error, ctx) => {
    ...
    switch (error.message) {
        ...
        case CDKEY_IS_INVALID:
            ...
            break;
        case ORDER_NO_IS_REQUIRED:
            status = 400
            message = ORDER_NO_IS_REQUIRED
            break;
        case ORDER_NO_IS_INVALID:
            status = 400
            message = ORDER_NO_IS_INVALID
            break;
        case AVATAR_IS_REQUIRED:
            status = 400
